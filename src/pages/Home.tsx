    ...
    <div className="pb-8">
      ...
      <section id="principiantes" className="site-container mt-3 grid gap-3 lg:grid-cols-2">
        ...
        <div id="comunidad" className="grid gap-3 sm:grid-cols-2">
          <Link to="/notas" className="overflow-hidden rounded-lg border border-cls-line sm:col-span-2">
            <picture>
          ...
          <div className="overflow-hidden rounded-lg border border-cls-line">
            <picture>
          ...
          <button type="button" onClick={() => window.dispatchEvent(new CustomEvent("cls:open-bot"))} className="overflow-hidden rounded-lg border border-cls-line text-left transition hover:-translate-y-0.5 hover:shadow-lift">
            <picture>
