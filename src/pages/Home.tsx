        ...
        <div id="comunidad" className="grid gap-3 sm:grid-cols-2">
          <Link to="/notas" className="relative min-h-[178px] overflow-hidden rounded-2xl sm:col-span-2">
            <picture>
              ...
              <img src="/images/home/fundacion-horizontal.png" alt="Fundación — Comunidad de cultivadoras" width="1200" height="600" loading="lazy" decoding="async" className="absolute -inset-2 h-[calc(100%+16px)] w-[calc(100%+16px)] object-cover" />
            </picture>
          </Link>
          <div className="relative min-h-[160px] overflow-hidden rounded-2xl">
            <picture>
              ...
              <img src="/images/home/comunidad-horizontal.png" alt="Comunidad — Cultivando en comunidad" width="600" height="400" loading="lazy" decoding="async" className="absolute -inset-2 h-[calc(100%+16px)] w-[calc(100%+16px)] object-cover" />
            </picture>
          </div>
          <button type="button" onClick={() => window.dispatchEvent(new CustomEvent("cls:open-bot"))} className="relative min-h-[160px] overflow-hidden rounded-2xl text-left transition hover:-translate-y-0.5 hover:shadow-lift">
            <picture>
              ...
              <img src="/images/home/doctor-horizontal.png" alt="Plant Doctor — Diagnóstico en vivo" width="600" height="400" loading="lazy" decoding="async" className="absolute -inset-2 h-[calc(100%+16px)] w-[calc(100%+16px)] object-cover" />
            </picture>
          </button>
        </div>
      </section>
